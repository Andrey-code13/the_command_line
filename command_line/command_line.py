...
- **ls {опция} [каталог]**: Вывод списка содержимого указанного каталога или текущего каталога, если каталог не указан. 
  Если на месте опции указано -l, то выводится подробная информация.
